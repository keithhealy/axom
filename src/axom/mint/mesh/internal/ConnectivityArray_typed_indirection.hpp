...
/// @{
  ...
  ConnectivityArray( IndexType ID_capacity=USE_DEFAULT,
    ...
    m_values( nullptr ),
    m_types( new Array< CellType >( axom::mint::internal::ZERO, 1,
                                    ID_capacity ) ),
    m_offsets( new Array< IndexType >( axom::mint::internal::ZERO,
                                       1,
                                       m_types->capacity() + 1 ) )
  {
    IndexType new_value_capacity =
      internal::calcValueCapacity( 0, getIDCapacity(), 0, value_capacity );
    m_values = new Array< IndexType >( axom::mint::internal::ZERO,
