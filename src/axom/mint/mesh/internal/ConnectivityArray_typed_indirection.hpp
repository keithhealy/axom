...
/// @{
  ...
  ConnectivityArray( IndexType ID_capacity=USE_DEFAULT,
    ...
    m_values( nullptr ),
    m_types( new MCArray< CellType >( axom::internal::ZERO, 1,
                                      ID_capacity ) ),
    m_offsets( new MCArray< IndexType >( axom::internal::ZERO,
                                         1,
                                         m_types->capacity() + 1 ) )
  {
    IndexType new_value_capacity =
      internal::calcValueCapacity( 0, getIDCapacity(), 0, value_capacity );
    m_values = new MCArray< IndexType >( axom::internal::ZERO,
...
/// @{
  ...
  ConnectivityArray( IndexType n_IDs, IndexType* values, IndexType* offsets,
    ...
    m_offsets( new MCArray< IndexType >( offsets, n_IDs + 1, 1,
                                         m_types->capacity() + 1 ) )
  {
