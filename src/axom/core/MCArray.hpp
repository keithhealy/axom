...
/// @{
   ...
   */
  MCArray( IndexType num_tuples, IndexType num_components=1,
...
/// @{
   ...
   */
  MCArray( T* data, IndexType num_tuples, IndexType num_components=1,
         IndexType capacity=0 );
...
//------------------------------------------------------------------------------
template< typename T >
MCArray< T >::MCArray( IndexType num_tuples, IndexType num_components,
                   IndexType capacity ) :
  m_data( nullptr ),
  m_num_tuples( 0 ),
  m_capacity( 0 ),
...
//------------------------------------------------------------------------------
template< typename T >
MCArray< T >::MCArray( T* data, IndexType num_tuples, IndexType num_components,
                   IndexType capacity ) :
  m_data( data ),
